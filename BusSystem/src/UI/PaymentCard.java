...
public class PaymentCard extends javax.swing.JDialog {
    ...
    public PaymentCard(java.awt.Frame parent, boolean modal,String scId,
            String[] seatIds, String busId, double price, String cusId) {
        
        super(parent, modal);
        initComponents();
        setTitle("Payment By Card");
    ...
    private void initComponents() {
        ...
        comBoxPaymentType = new javax.swing.JComboBox();
        ...
        lblPayType.setForeground(new java.awt.Color(255, 255, 255));
        ...
        comBoxPaymentType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "", "Visa", "Master Card", "American Express" }));

        lblCardNo.setForeground(new java.awt.Color(255, 255, 255));
        lblCardNo.setText("Card Number:");

        tfCardNo.setForeground(new java.awt.Color(204, 204, 204));
        tfCardNo.setText("15 - 16 digits");
                ...
                .addGroup(pnlScreenLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(pnlScreenLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlScreenLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(tfScheduleId, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(tfTotalSeats, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 70, Short.MAX_VALUE))
                        .addGap(18, 18, 18)
                        .addGroup(pnlScreenLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlScreenLayout.createSequentialGroup()
                        .addGroup(pnlScreenLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pnlScreenLayout.createSequentialGroup()
                                .addGroup(pnlScreenLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addGroup(pnlScreenLayout.createSequentialGroup()
                                    ...
                                    .addGroup(pnlScreenLayout.createSequentialGroup()
                                        ...
                                        .addGroup(pnlScreenLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(comBoxPaymentType, 0, 116, Short.MAX_VALUE))))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGroup(pnlScreenLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        pnlScreenLayout.setVerticalGroup(
            ...
            .addGroup(pnlScreenLayout.createSequentialGroup()
                ...
                .addGroup(pnlScreenLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(lblPayType)
                    .addComponent(comBoxPaymentType, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(pnlScreenLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlScreenLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        try {
            ...
            String paymentType=(String)comBoxPaymentType.getSelectedItem();
            ...
            if(isAddedTicket){
                ...
                scs = stAl.addSeatTicket(seatIds, ticketId);
            }
            if(scs){
                ...
                print.setPaymentType((String)comBoxPaymentType.getSelectedItem());
                print.setCardNo(tfCardNo.getText());

                boolean isValid = print.printCardBill();
                ...
                JOptionPane.showMessageDialog(this,"Unable print receipt");
            }
        } catch (Exception e) {
    ...
    private javax.swing.JComboBox comBoxPaymentType;
